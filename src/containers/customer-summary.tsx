...
import type {
  Customer,
  CustomerNote as CustomerNotesInterface
} from '../types/customer';
...
interface NotesState {
  data?: CustomerNotesInterface[];
  error?: string;
  isLoading: boolean;
}

export const CustomerSummary: FC = () => {
  ...
  const [notesState, setNotesState] = useState<NotesState>({ isLoading: true });
