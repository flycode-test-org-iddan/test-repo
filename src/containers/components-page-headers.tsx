...
export const ComponentsPageHeaders: FC = () => {
  useEffect(() => {
            ...
            <div>
              ...
              <Card sx={{ px: 3 }} variant="outlined">
                <Box sx={{ py: 4 }}>
                  ...
                  <Grid container spacing={2} sx={{ mt: 2 }} wrap="wrap">
                    <Grid
                      item
                      sx={{
                        alignItems: 'center',
                ...
                <Box sx={{ py: 4 }}>
                  <Box sx={{ mb: 2 }}>
                    <Breadcrumbs separator="•">
                      <Link color="textSecondary" href="#" underline="hover">
                        Home
                      </Link>
                      <Link color="textSecondary" href="#" underline="hover">
                        Customers
