      ...
      >
        ...
        >
          <FaqCard question="Do you have a free demo to review the code before purchasing?">
            ...
            which should give you an overview of the code quality and folder
            structure.
            <br />
            <br />
            Keep in mind that some aspects may differ from the Carpatin - Admin
            Dashboard Paid version.
          </FaqCard>
          <FaqCard question="How many projects can I build with Carpatin - Admin Dashboard?">
            The license is per project (domain), but if you intend to develop an
            unknown number of projects feel free to{' '}
            <Link
              color="primary"
        ...
        >
          ...
          <FaqCard question="What browsers does Carpatin - Admin Dashboard support?">
            The components in Material-UI are designed to work in the latest,
            stable releases of all major browsers, including Chrome, Firefox,
            Safari, and Edge.
            <br />
            <br />
        ...
        >
          <FaqCard question="For what kind of projects is the Standard license intended?">
            ...
            staff will access the application.
            <br />
            <br />
            An example could be the back-office dashboard of a public-facing
            e-commerce website in which staff would sign in and manage
            inventory, customers, etc.
          </FaqCard>
          <FaqCard question="Does Carpatin - Admin Dashboard include Figma, Sketch, or Adobe XD files?">
            The Standard Plus license includes an expertly designed complete
            Figma kit that takes advantage of modern Figma features like
            ...
            <br />
            <br />
            We don&apos;t include assets for other design tools such as Sketch
            or Adobe XD.
          </FaqCard>
        </Box>
      </Box>
