      ...
      <Card elevation={0} sx={{ backgroundColor: 'neutral.100' }}>
        ...
        >
          ...
          >
            ...
            >
              We&apos;ve included the source Figma files in Plus &amp; Extended
          ...
          >
            ...
            >
              Our support team is here to help you get started with any
              template-related questions. We answer pretty fast.
            </Typography>
            <Box sx={{ flexGrow: 1 }} />
            <Box
              sx={{
