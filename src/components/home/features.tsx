...
const features = [
  ...
  {
    description:
      'Screens come connected to a fake server api client and state management system, and can be hooked to your real server in no time.',
    image: '/static/feature-loading-states.png',
    name: 'Loading and Error states'
  },
  {
    description:
      'When it comes to management, it’s important to have good tools for specific needs, so we included a powerful filter system so you won’t have to build one.',
    ...
    <Container maxWidth="lg">
      ...
      >
        {features.map((feature) => (
          <Grid item key={feature.name} md={4} xs={12}>
            <Box
              sx={{
      ...
      <Grid container>
        ...
        >
          ...
          <Typography color="textPrimary" sx={{ my: 1 }} variant="h5">
            Responsive
          </Typography>
          <Typography color="textSecondary" variant="subtitle1">
        ...
        >
          ...
          <Typography color="textSecondary" variant="subtitle1">
            We continuously deploy new updates which include updated
            dependencies, new screens and bug fixes.
          </Typography>
        </Grid>
      </Grid>
    </Container>
