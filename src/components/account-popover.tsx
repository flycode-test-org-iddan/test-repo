...
interface AccountPopoverProps {
  ...
  darkMode: boolean;
  onLanguageChange: (newLanguage: 'en-US' | 'de-DE' | 'es-ES') => void;
...
export const AccountPopover: FC<AccountPopoverProps> = (props) => {
  ...
  const handleLanguageChange = (event: ChangeEvent<HTMLInputElement>): void => {
    onLanguageChange(event.target.value as 'en-US' | 'de-DE' | 'es-ES');
  };
          ...
          <li>
            <List disablePadding>
              ...
              <ListItem divider sx={{ pt: 0 }}>
                <Switch checked={rtlDirection} onChange={onSwitchDirection} />
                <Typography color="textPrimary" variant="body2">
                  RTL
                </Typography>
              </ListItem>
