  ...
  return (
    <Card variant="outlined" {...other}>
      ...
      <Grid container>
        ...
        <Grid item sm={6} xs={12}>
          <PropertyList>
            <PropertyListItem label="Status" value={statusVariant.label} />
            <PropertyListItem label="Address" value={order.customer.address} />
            <PropertyListItem label="Country" value={order.customer.country} />
          </PropertyList>
        </Grid>
      </Grid>
    </Card>
